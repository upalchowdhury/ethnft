...
#/Users/upalc/Documents/ethapp/ethnft/ethnft/nftproject/metadata/rinkeby/0-train-3.png.json
...
def main():
    ...
    for token_id in range(number_of_collectible):
        ...
        print(image)
        metadata_file_name = metadata[0]
        #f"./metadata/{network.show_active()}/{token_id}-{image}.json"
